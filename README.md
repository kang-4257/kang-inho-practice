...
| [Application Architecture](https://github.com/kang-4257/kang-inho-practice/wiki/Application-Architecture) | 기술 스택 선택 근거 및 앱 구조 |
| [ERD](https://github.com/kang-4257/kang-inho-practice/wiki/ERD) | DB 테이블 구조 및 관계 |
| [Infra Architecture](https://github.com/kang-4257/kang-inho-practice/wiki/Infra-Architecture) | 인프라 구성 및 네임스페이스 |
| [Monitoring](https://github.com/kang-4257/kang-inho-practice/wiki/Monitoring) | Grafana/Prometheus 모니터링 |
| [DevSecOps Pipeline](https://github.com/kang-4257/kang-inho-practice/wiki/DevSecOps-Pipeline) | CI/CD 파이프라인 12단계 |
| [Security](https://github.com/kang-4257/kang-inho-practice/wiki/Security) | 보안 구성 |
| [Attack & Failure Scenario Test](https://github.com/kang-4257/kang-inho-practice/wiki/Attack-&-Failure-Scenario-Test) | 장애 및 공격 시나리오 테스트 |
| [Performance Test](https://github.com/kang-4257/kang-inho-practice/wiki/Performance-Test) | 부하 테스트 결과 및 회고 |
| [Vulnerability Fix History](https://github.com/kang-4257/kang-inho-practice/wiki/Vulnerability-Fix-History) | AI 보고서 기반 취약점 수정 이력 |
